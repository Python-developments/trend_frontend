...
class SearchHashtagsModel extends SearchHashtags {
  ...
  factory SearchHashtagsModel.fromJson(final Map<String, dynamic> json) {
    return SearchHashtagsModel(
      hashtags: json['hashtags'] == null
          ? []
          : List<Hashtag>.from(json['hashtags']!
              .map((final x) => HashtagsModel.fromJson(x))),
    );
  }
}
...
class HashtagsModel extends Hashtag {
  ...
  factory HashtagsModel.fromJson(final Map<String, dynamic> json) {
