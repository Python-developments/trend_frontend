...
import '../../../explore/data/models/local/user_details_model.dart';
import '../../../explore/presentation/manager/for_you/for_you_search_bloc.dart';
import '../../../explore/presentation/manager/for_you/for_you_search_event.dart';
import '../../../explore/presentation/manager/for_you/for_you_search_state.dart';
import '../../../explore/presentation/manager/hashtags/hashtags_bloc.dart';
import '../../../explore/presentation/manager/location/location_bloc.dart';
import '../../../explore/presentation/widgets/user_account_details.dart';
    ...
    Navigator.push(
      ...
      PageRouteBuilder(
        pageBuilder: (context, _, __) => MultiBlocProvider(
          providers: [
            BlocProvider(create: (_) => ForYouSearchBloc(searchExploreUseCase: sl(), userSearchUseCase: sl())),
            BlocProvider(create: (_) => HashtagsBloc(hashtagsUseCase: sl())),
            BlocProvider(create: (_) => LocationSearchesBloc(locationSearchUseCase: sl())),
          ],
          ...
          child: Row(
            children: [
              Flexible(
                child: FittedBox(
                  child: IconButton(
                    onPressed: () => Navigator.canPop(context) ? Navigator.pushNamed(context, AppRoutes.home) : null,
                    icon: const Icon(Icons.arrow_back_ios, size: 20, color: Color(AppColors.black)),
                  ),
                ),
              ),
                ...
                child: Form(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      prefixIcon: const Icon(FontAwesomeIcons.search, size: 16, color: Colors.black),
                      hintText: 'Search',
                      hintStyle: AppStyles.styleNormal13(context).copyWith(color: const Color(AppColors.greyDark)),
                      fillColor: const Color(AppColors.greyLighter).withOpacity(0.2),
                      filled: true,
