...
import '../../../explore/presentation/widgets/for_you/explore_list_search_users.dart';
import '../../../explore/presentation/widgets/for_you/explore_search_for_you_post.dart';
  ...
  Widget build(BuildContext context) {
    return CustomScrollView(
      slivers: [
        ...
        SliverToBoxAdapter(
          child: Padding(
            padding: const EdgeInsets.only(top: 14.0, left: 12.0, right: 12.0, bottom: 7.0),
            child: Text(
              explorePost,
              style: AppStyles.styleNormal16(context).copyWith(color: Color(AppColors.black)),
            ),
