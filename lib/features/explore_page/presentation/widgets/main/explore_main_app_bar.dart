...
import 'package:trend/features/explore/presentation/manager/for_you/for_you_search_bloc.dart';
...
class ExploreMainAppBarContainer extends StatelessWidget implements PreferredSizeWidget {
      ...
      child: InkWell(
        onTap: () {
          Navigator.push(
              context,
              PageRouteBuilder(
                pageBuilder: (context, animation, secondaryAnimation) => MultiBlocProvider(providers: [
                  BlocProvider(
