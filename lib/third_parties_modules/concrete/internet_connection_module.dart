...
class InternetConnectionModule extends IInternetConnectionModule{
  ...
  InternetConnectionModule(super.connectivity) {
    ...
    connectionStream= connectivity.onConnectivityChanged.listen((final List<ConnectivityResult> newValues) {
      isConnectedToInternet=newValues.any((final ConnectivityResult element) => <ConnectivityResult>[ConnectivityResult.wifi,ConnectivityResult.mobile,
        ConnectivityResult.vpn].contains(element));
    });
  }
  @override
  ...
  @override
  void addListener(final void Function(bool hasInternetConnection)listener)=>connectivity.onConnectivityChanged.listen((final _)=>
      listener(hasInternetConnection));
